            ...
            <SectionContainer background="light">
                ...
                <div className="flex flex-wrap justify-center gap-6 max-w-7xl mx-auto">
                    {[
                        ...
                        <div key={index} className="w-full md:w-[calc(50%-1.5rem)] lg:w-[calc(33.333%-1.5rem)] flex">
                            <Card className="hover:shadow-lg transition-all duration-300 border-t-4 border-primary-600 border-x-0 border-b-0 rounded-lg group">
                                <div className="flex flex-col gap-4">
                                    <div className="w-12 h-12 bg-primary-50 rounded-xl flex items-center justify-center text-primary-700 group-hover:bg-primary-100 transition-colors">
                                        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d={benefit.icon} />
                                        </svg>
                                    </div>
                                    <div>
                                        <h3 className="font-bold text-neutral-900 text-lg mb-2">{benefit.title}</h3>
    ...
    return (
        <Card className="hover:shadow-lg transition-all duration-300 border-l-4 border-primary-600 border-t-0 border-r-0 border-b-0 rounded-lg group h-full">
            <div className="flex flex-col gap-4">
                ...
                <div>
                    <h3 className="font-bold text-neutral-900 text-lg mb-2">{highlight.title}</h3>
                    <p className="text-neutral-600 text-sm leading-relaxed">{highlight.description}</p>
                </div>
            </div>
        </Card>
    );
