                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <div className="flex flex-col items-center">
                        <img
                            ...
                            className="max-h-14 md:max-h-20 w-auto mx-auto object-contain mb-3"
                        />
                        <div className="flex flex-col items-center">
                            <h3 className="text-sm md:text-base font-bold text-neutral-900">Conference Alerts</h3>
                            <a
                                href="https://allconferencealert.net/india.php"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="text-xs md:text-sm text-primary-600 hover:text-primary-700 hover:underline transition-all duration-300 break-all"
                            >
