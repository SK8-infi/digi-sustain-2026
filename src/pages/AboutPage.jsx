            ...
            <SectionContainer background="white">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <div style={{ borderLeft: '4px solid #1a4731' }} className="pl-6 py-2 bg-neutral-50 rounded-r-lg">
                    ...
                    <div className="hidden lg:block">
                        <div style={{ backgroundColor: '#1a4731' }} className="rounded-2xl p-8 text-white relative overflow-hidden shadow-xl">
                            <div className="relative z-10">
                                <h3 style={{ color: '#ffffff' }} className="text-2xl font-bold mb-4">Vision 2047</h3>
                                <p style={{ color: '#f0fdf4' }} className="leading-relaxed opacity-90">
