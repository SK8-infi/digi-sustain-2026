        ...
        <Card className={`relative h-full transition-all duration-300 hover:shadow-lg hover:border-primary-300 border-b-4 ${accents[variant]} border-t-0 border-x-0 rounded-lg bg-white group overflow-hidden`}>
            <div className="p-2">
                ...
                <div className="flex justify-between items-start mb-3 gap-2">
                    {/* Unique Icon */}
                    <div className={`p-2 rounded-xl ${iconColors[variant]} transition-colors duration-300 flex-shrink-0`}>
                ...
                <div className="w-full">
                    <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2 leading-tight group-hover:text-primary-800 transition-colors">
                        {track.title}
                    </h3>
